...
public class studentcontroller {
    ...
    @ApiImplicitParams({@ApiImplicitParam(name="stuId",value = "学号",paramType = "query",dataType = "int"),
            @ApiImplicitParam(name="name",value = "学生姓名",paramType = "query",dataType = "String")})
    public Message update(int stuId,String name){
        return MessageUtil.success("更新学生信息成功");
    ...
    @ApiImplicitParams({@ApiImplicitParam(name="stuId",value = "学号",paramType = "query",dataType = "int"),
            @ApiImplicitParam(name="name",value = "学生姓名",paramType = "query",dataType = "String")})
    public Message search(int stuId,String name){
        return MessageUtil.success("查询学生信息成功");
    }
}
